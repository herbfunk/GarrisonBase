...
namespace Herbfunk.GarrisonBase.Garrison.Objects
{
    public class Building
    {
        ...
        public WoWObject WorkOrderNpc
        {
            get
            {
                if (_workOrderNpc == null)
                    _workOrderNpc = CacheStaticLookUp.GetWoWObject(WorkOrderNPCEntryId).ToGameObject();
                else if (!_workOrderNpc.IsValid)
                    _workOrderNpc = null;
                return _workOrderNpc;
            }
            set { _workOrderNpc = value; }
        }
        private WoWObject _workOrderNpc;
        ...
        public Building(string id)
        {
            ...
            BuildingPolygon = MovementCache.MovementPolygons.FirstOrDefault(p => p.PlotIds.Contains(Convert.ToInt32(PlotId)));
        }
