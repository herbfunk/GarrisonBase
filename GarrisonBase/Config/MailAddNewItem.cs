...
namespace Herbfunk.GarrisonBase.Config
{
    public partial class MailAddNewItem : Form
    {
        ...
        public MailAddNewItem()
        {
            ...
            bagitems = new List<C_WoWItem>(Character.Player.Inventory.GetBagItemsBOE()).Where(i => !ignoredIds.Contains((int)i.Entry)).OrderBy(i => i.Name).ToList();
            bankitems = new List<C_WoWItem>(Character.Player.Inventory.GetBankItemsBOE()).Where(i => !ignoredIds.Contains((int)i.Entry)).OrderBy(i => i.Name).ToList();
            reagentbankitems = new List<C_WoWItem>(Character.Player.Inventory.GetReagentBankItemsBOE()).Where(i => !ignoredIds.Contains((int)i.Entry)).OrderBy(i => i.Name).ToList();
